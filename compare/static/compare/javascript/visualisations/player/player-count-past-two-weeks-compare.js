function player_count_past_two_weeks_compare(ids){

    let player_data = get_data_player_count_past_two_weeks_compare(ids)
    ...
    if(player_data.length > 0) {
        ...
        function mousemove(event){
            ...
            focus_all.forEach(function(value, index){
                ...
                time = time.getDate() + "/" + time.getMonth() + "/" + time.getFullYear();                if(index == 0){
