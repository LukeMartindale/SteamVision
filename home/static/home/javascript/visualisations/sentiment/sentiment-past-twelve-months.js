function get_data_sentiment_past_twelve_months(id){

    let api_url = `/api/get-sentiment/past-twelve-months/${id}/`
...
function sentiment_past_twelve_months(id){

    let reviews_data = get_data_sentiment_past_twelve_months(id)
    ...
    sentiment_update_current_value(reviews_data, "twelve-months") 
