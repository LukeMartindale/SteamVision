function get_data_sentiment_past_six_months(id){

    let api_url = `/api/get-sentiment/past-six-months/${id}/`
...
function sentiment_past_six_months(id){

    let reviews_data = get_data_sentiment_past_six_months(id)
    ...
    if(max_value > 0){
        ...
        sentiment_update_current_value(reviews_data, "six-months")
