function get_data_player_count_past_two_weeks(id){

    let api_url = `/api/get-player-count/past-two-weeks/${id}/`
...
function player_count_past_two_weeks(id){

    let player_data = get_data_player_count_past_two_weeks(id)
