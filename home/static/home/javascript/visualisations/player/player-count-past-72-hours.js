function get_data_player_count_past_72_hours(id){

    let api_url = `/api/get-player-count/past-72-hours/${id}/`
...
function player_count_past_72_hours(id){

    let player_data = get_data_player_count_past_72_hours(id)
