function get_data_player_count_past_one_month(id){

    let api_url = `/api/get-player-count/past-one-month/${id}/`
...
function player_count_past_one_month(id){

    let player_data = get_data_player_count_past_one_month(id)
