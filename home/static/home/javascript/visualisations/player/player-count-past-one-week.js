function get_data_player_count_past_one_week(id){

    let api_url = `/api/get-player-count/past-one-week/${id}/`
...
function player_count_past_one_week(id){

    let player_data = get_data_player_count_past_one_week(id)
    ...
    function mousemove(event){
        ...
        time = time.getDate() + "/" + time.getMonth() + "/" + time.getFullYear() + " - " + time.getHours() + ":" + time.getTime();
