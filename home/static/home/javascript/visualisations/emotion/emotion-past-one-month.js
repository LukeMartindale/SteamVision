function get_data_emotion_past_one_month(id){

    let api_url = `/api/get-emotion/past-one-month/${id}/`
...
function emotion_past_one_month(id){

    let reviews_data = get_data_emotion_past_one_month(id)
    console.log("emotion-past-one-month")
